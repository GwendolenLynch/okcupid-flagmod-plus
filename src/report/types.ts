...
export const LABEL_PROFILE_OTHER = 6;

export const LABEL_IMAGE_OFFENSIVE = 7;
export const LABEL_IMAGE_NUDITY = 8;
export const LABEL_IMAGE_NTU = 9;
export const LABEL_IMAGE_OTHER = 10;
